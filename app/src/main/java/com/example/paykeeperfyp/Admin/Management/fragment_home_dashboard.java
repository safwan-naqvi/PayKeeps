...
public class fragment_home_dashboard extends Fragment {
    String user_id;
    TextView debitbalance,creditbalance,netbalance,see_all,net_amount_symbol,debit_amount_symbol,credit_amount_symbol;
